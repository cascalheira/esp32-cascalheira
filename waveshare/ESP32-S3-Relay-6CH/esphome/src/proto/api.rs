...
pub struct SerialProxyInfo {
    ...
    pub port_type: i32,
    /// Bitmask of SerialProxyLineStateFlags this instance can drive
    #[prost(uint32, tag = "3")]
    pub configured_line_states: u32,
}
...
pub struct DeviceInfoResponse {
    ...
    #[prost(bool, tag = "26")]
    pub api_encryption_provisionable: bool,
}
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct BluetoothProxyCapabilities {
...
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct VoiceAssistantCapabilities {
    /// Bitmask of the features this voice assistant supports
    #[prost(uint32, tag = "1")]
    pub feature_flags: u32,
}
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ZWaveProxyCapabilities {
    /// Bitmask of the features this proxy supports
    #[prost(uint32, tag = "1")]
    pub feature_flags: u32,
    #[prost(uint32, tag = "2")]
...
pub struct DeviceCapabilitiesResponse {
    ...
    pub bluetooth_proxy: ::core::option::Option<BluetoothProxyCapabilities>,
    #[prost(message, optional, tag = "2")]
    pub voice_assistant: ::core::option::Option<VoiceAssistantCapabilities>,
    #[prost(message, optional, tag = "3")]
    pub zwave_proxy: ::core::option::Option<ZWaveProxyCapabilities>,
...
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ZWaveProxyRequestResponse {
    /// Which request type this responds to
    #[prost(enumeration = "ZWaveProxyRequestType", tag = "1")]
    pub r#type: i32,
    /// Result status
    #[prost(enumeration = "ZWaveProxyStatus", tag = "2")]
    pub status: i32,
}
...
pub struct SerialProxyGetModemPinsResponse {
    ...
    #[prost(uint32, tag = "2")]
    pub line_states: u32,
    /// INVALID_ARGUMENT if the instance index is out of range (since API 1.16)
...
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
#[repr(i32)]
pub enum ZWaveProxyStatus {
    /// Request completed successfully
    ZwaveProxyStatusOk = 0,
    /// Denied: another client is already subscribed
    ZwaveProxyStatusInUse = 1,
    /// Request type not supported
    ZwaveProxyStatusNotSupported = 2,
}
impl ZWaveProxyStatus {
    /// String value of the enum field names used in the ProtoBuf definition.
    ///
    /// The values are not transformed in any way and thus are considered stable
    /// (if the ProtoBuf definition does not change) and safe for programmatic use.
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::ZwaveProxyStatusOk => "ZWAVE_PROXY_STATUS_OK",
            Self::ZwaveProxyStatusInUse => "ZWAVE_PROXY_STATUS_IN_USE",
            Self::ZwaveProxyStatusNotSupported => "ZWAVE_PROXY_STATUS_NOT_SUPPORTED",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "ZWAVE_PROXY_STATUS_OK" => Some(Self::ZwaveProxyStatusOk),
            "ZWAVE_PROXY_STATUS_IN_USE" => Some(Self::ZwaveProxyStatusInUse),
            "ZWAVE_PROXY_STATUS_NOT_SUPPORTED" => {
                Some(Self::ZwaveProxyStatusNotSupported)
            }
            _ => None,
        }
    }
...
pub enum SerialProxyRequestType {
    ...
    ///
    /// Acknowledges a SerialProxyConfigureRequest
    Configure = 3,
    /// Acknowledges a SerialProxySetModemPinsRequest
    SetModemPins = 4,
}
impl SerialProxyRequestType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::Configure => "SERIAL_PROXY_REQUEST_TYPE_CONFIGURE",
            Self::SetModemPins => "SERIAL_PROXY_REQUEST_TYPE_SET_MODEM_PINS",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "SERIAL_PROXY_REQUEST_TYPE_CONFIGURE" => Some(Self::Configure),
            "SERIAL_PROXY_REQUEST_TYPE_SET_MODEM_PINS" => Some(Self::SetModemPins),
            _ => None,
        }
    }
}
...
pub enum SerialProxyStatus {
    ...
    NotSupported = 4,
    /// Denied: another client holds the port
    PortInUse = 5,
    /// Invalid instance index or parameter value
    InvalidArgument = 6,
}
impl SerialProxyStatus {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::PortInUse => "SERIAL_PROXY_STATUS_PORT_IN_USE",
            Self::InvalidArgument => "SERIAL_PROXY_STATUS_INVALID_ARGUMENT",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "SERIAL_PROXY_STATUS_PORT_IN_USE" => Some(Self::PortInUse),
            "SERIAL_PROXY_STATUS_INVALID_ARGUMENT" => Some(Self::InvalidArgument),
            _ => None,
        }
    }
}
