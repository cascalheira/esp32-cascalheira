...
| 14 ✅ 2026-09-05 fw 0.14.1: quality pass (clippy clean, 8-angle code review): Driver enum in core, rain hold expires in Off, typed snapshot + Arc swap, page rebuild once, rain-hold control on the page | Follow-ups |
| 13 ✅ 2026-09-05 fw 0.14.0: schedule preview grid on the setup page (`/api/schedule` snapshot refreshed by the main loop) | Follow-ups |
...
| 8 ✅ 2026-09-05 fw 0.9.0: local rain hold (number + status text; pauses the stored schedule, persisted) | Follow-ups |
